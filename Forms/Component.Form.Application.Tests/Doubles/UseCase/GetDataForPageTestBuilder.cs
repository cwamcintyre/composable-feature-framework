...
public class GetDataForPageTestBuilder
{
    ...
    public GetDataForPageTestBuilder()
    {
        ...
        _serviceCollection.AddSingleton(new Mock<ILogger<GetDataForPage>>().Object);
        ...
        _serviceCollection.AddTransient<GetDataForPage>();
    }
    ...
    public GetDataForPage Build()
    {
        _serviceProvider = _serviceCollection.BuildServiceProvider();
        return _serviceProvider.GetRequiredService<GetDataForPage>();
    }
}