...
public class ProcessFormTestBuilder
{
    private readonly ServiceCollection _serviceCollection;

    public ProcessFormTestBuilder()
    {
        ...
        _serviceCollection.AddSingleton(new Mock<ILogger<ProcessForm>>().Object);
        ...
        _serviceCollection.AddTransient<ProcessForm>();
    }

    public ProcessFormTestBuilder WithFormDataStore(IFormDataStore formDataStore)
    {
    ...
    public ProcessForm Build()
    {
        ...
        return serviceProvider.GetRequiredService<ProcessForm>();
    }
}
